...
return array(
    ...
    "Invalid type given. String expected" => "Invalid type given. String expected",
    "'%value%' is no valid email address in the basic format local-part@hostname" => "邮箱格式错误",
    ...
    "The two given tokens do not match" => "两次密码不匹配",
    ...
    "'%value%' is more than %max% characters long" => "不能超过个%max%字",
);
